...
export const metadata: Metadata = {
  ...
  description: `Latest stories and updates from ${siteConfig.name}`,
}
...
export default async function BlogPage() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      {/* Hero Section */}
      <PageHero
        badgeText="Stories & Updates"
        title="Blog"
        subtitle={`Latest stories and updates from ${siteConfig.name}`}
        className="bg-gradient-to-br from-primary-950 via-primary-900 to-accent-900"
      />
