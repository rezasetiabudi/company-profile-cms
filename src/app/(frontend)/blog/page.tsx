...
export const metadata: Metadata = {
  title: 'Blog - PT Nusantara Fiber Konektifitas',
  description: 'Blog dan cerita terkini dari PT Nusantara Fiber Konektifitas',
}
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary-950 via-primary-900 to-accent-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 text-center">
          <span className="inline-block text-accent-400 font-semibold text-sm uppercase tracking-wider mb-4">Cerita & Update</span>
          <h1 className="text-4xl md:text-5xl font-heading font-bold text-white mb-5 tracking-tight">Blog</h1>
          <p className="text-xl text-primary-200 max-w-2xl mx-auto leading-relaxed">
            Cerita dan update terkini dari PT Nusantara Fiber Konektifitas
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {posts.length === 0 ? (
            <div className="text-center py-20">
              ...
              <p className="text-gray-500 text-lg">Belum ada postingan blog yang tersedia.</p>
            </div>
          ) : (
                ...
                >
                  ...
                  {!post.featuredImage && (
                    <div className="h-48 bg-gradient-to-br from-accent-500 to-accent-700 flex items-center justify-center">
                      <span className="text-4xl text-white/20 font-bold">B</span>
                    </div>
                  )}
                  <div className="p-6">
                    {post.publishedAt && (
