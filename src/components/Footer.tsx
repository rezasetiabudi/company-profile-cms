        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
              ...
              <div className="flex space-x-3">
                {socialMedia.map((social) => (
                  <a
                    ...
                    className="text-primary-400 hover:text-accent-400 transition-colors p-2 rounded-lg hover:bg-primary-900"
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/blog" className="text-primary-300 hover:text-white transition-colors text-sm">
                  Blog
                </Link>
              </li>
            </ul>
            ...
            <ul className="space-y-4 text-primary-300 text-sm">
              {phone && (
                <li className="flex items-start space-x-3">
                  <svg className="w-5 h-5 text-accent-500 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
